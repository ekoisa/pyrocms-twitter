 ...
 * Tweet library
 * 
 * @author Elliot haugin
 * @author http://www.haughin.com/code/twitter
 * 
 * @package		OursITShow
 * @subpackage  TweetLibrary
 * @category  	Library
 *
 */
class tweet {
...
class tweetConnection {
	...
	public function get($url, $params)
	{
		...
		return $this->_addCurl($url, $params);
	}
...
class tweetOauth extends tweetConnection {
	...
	function __construct()
	{
		...
		$twitter_consumer_key = $this->_obj->settings_m->get('twitter_consumer_key');
		$twitter_consumer_key_secret = $this->_obj->settings_m->get('twitter_consumer_key_secret');
		
		$this->_tokens =	array(
			'consumer_key' 		=> $twitter_consumer_key->value,
			'consumer_secret' 	=> $twitter_consumer_key_secret->value,
